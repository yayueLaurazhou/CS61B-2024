...
//            if (isRowComplete(tiles[i])){
//                System.out.println("a row is complete");
//                linesCleared ++;
//                clearRow(i, tiles);
//                i ++;
//            }
...
//    private boolean isRowComplete(TETile[] row){
//        for (int i = 0; i < row.length; i ++){
//            if (row[i].equals(Tileset.NOTHING)){
//                return false;
//            }
//        }
//        return true;
//    }
    ...
    private void clearRow(int lineIndex, TETile[][] tiles){
        for (int j = lineIndex; j < HEIGHT - 1; j ++){
